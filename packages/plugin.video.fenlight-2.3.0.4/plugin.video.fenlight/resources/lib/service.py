...
class OnUpdateChanges:
	...
	def migrate_update_repo(self):
		legacy_username = get_setting('fenlight.update.username')
		legacy_location = get_setting('fenlight.update.location')
		updated = False
	...
	def force_fork_api_keys(self):
		...
		tmdb_key = 'd2ea206b6d678d6c6b58e91f4b3ea277'
		trakt_client = 'aa618129509de512fed7e55942de8dcd958b2b1500a29cae69526782f429b78c'
		trakt_secret = '96f636ac6c9c8cf75f6b638d03824cfa266220dc549bbc36b599fd2a5e686a0a'
		tmdb_changed = get_setting('fenlight.tmdb_api') != tmdb_key
		trakt_changed = get_setting('fenlight.trakt.client') != trakt_client or get_setting('fenlight.trakt.secret') != trakt_secret
		if tmdb_changed:
		...
		if trakt_changed:
			set_setting('trakt.client', trakt_client)
			set_setting('trakt.secret', trakt_secret)
